...
export const Settings = () => {
  ...
  return <div className="grid grid-cols-2 gap-2">
    <div className="col-span-1">
      <InputLabel className="mb-2" htmlFor="player-1">Player 1</InputLabel>
      <Input
        id="player-1"
        value={player1.name}
        onChange={({ target }) =>
    ...
    <div className="col-span-1">
      <InputLabel className="mb-2" htmlFor="player-2">Player 2</InputLabel>
      <Input
        id="player-2"
        value={player2.name}
        onChange={({ target }) =>
    ...
    <div className="col-span-full">
      ...
      <RadioGroup.Root
        ...
        onValueChange={(value) => setSettings(prev => ({ ...prev, pickerView: value as any }))}
      >
    ...
    <div className="col-span-full">
      <InputLabel className="mb-2" htmlFor="github">Github token</InputLabel>
      <Input
        id="github"
